...
ggsave("../../figs/map_school_density.png",p,height = 30, width = 30, units = "cm")
```
...
```{r}
ggplot(mar_tidy[grep("mat",mar_tidy$name),], aes(x = value, y = name)) +
  scale_x_continuous(limits = c(0,100))+
  geom_density_ridges()
```
...
```{r}
ggplot(mar_tidy[grep("len",mar_tidy$name),], aes(x = value, y = name)) +
  scale_x_continuous(limits = c(0,100))+
  geom_density_ridges()
```
...
```{r}
ggplot(mar_tidy[grep("mat",mar_tidy$name),], aes(x = value, y = name,fill=gm,alpha=0.6)) +
  scale_fill_manual(name = "Marginalization", values = c("High" = altoc, "Low" = bajoc, "Medium" = medioc, "Very High" = maltoc, "Very Low" = mbajoc),
                      labels = c("Very Low", "Low", "Medium", "High", "Very High"))+
  geom_density_ridges()+
  scale_x_continuous(limits = c(0,100))+
...
```{r}
ggplot(mar_tidy[grep("len",mar_tidy$name),], aes(x = value, y = name,fill=gm,alpha=0.6)) +
  scale_fill_manual(name = "Marginalization", values = c("High" = altoc, "Low" = bajoc, "Medium" = medioc, "Very High" = maltoc, "Very Low" = mbajoc),
                        labels = c("Very Low", "Low", "Medium", "High", "Very High"))+
    geom_density_ridges()+
  scale_x_continuous(limits = c(0,100))+
...
```{r}
ggplot(mar_tidy[grep("len",mar_tidy$name),], aes(x = value, y = name,fill=gm,alpha=0.6, height = stat(density))) +
  scale_fill_manual(name = "Marginalization", values = c("High" = altoc, "Low" = bajoc, "Medium" = medioc, "Very High" = maltoc, "Very Low" = mbajoc),
                        labels = c("Very Low", "Low", "Medium", "High", "Very High"))+
    geom_density_ridges(stat = "density")+
  scale_x_log10()+
...
```{r}
ggplot(mar_tidy[!grepl("II_",mar_tidy$name) & grepl("I_",mar_tidy$name),], aes(x = value, y = name,fill=gm,alpha=0.6)) +
  scale_fill_manual(name = "Marginalization", values = c("High" = altoc, "Low" = bajoc, "Medium" = medioc, "Very High" = maltoc, "Very Low" = mbajoc),
                        labels = c("Very Low", "Low", "Medium", "High", "Very High"))+
    geom_density_ridges()+
  scale_x_continuous(limits = c(0,100))+
...
```{r}
ggplot(mar_tidy[grepl("IV_",mar_tidy$name),], aes(x = value, y = name,fill=gm,alpha=0.6)) +
  scale_fill_manual(name = "Marginalization", values = c("High" = altoc, "Low" = bajoc, "Medium" = medioc, "Very High" = maltoc, "Very Low" = mbajoc),
                        labels = c("Very Low", "Low", "Medium", "High", "Very High"))+
    geom_density_ridges()+
  scale_x_continuous(limits = c(0,100))+
...
```{r}
for (i in 1:8){
  bnf <- bnlearn::h2pc(databn_finite[,c(i,9:19)])
  png(paste0("/figs/graph_",i,".png"))
  plot(graphviz.plot(bnf, shape = "ellipse"))
  dev.off()
  str.diff <- bnlearn::boot.strength(databn_finite[,c(i,9:19)],R=20,algorithm="h2pc")
...
```{r}
graphviz.plot(bnaracne, shape = "ellipse")
```
